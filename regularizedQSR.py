...
from netket.experimental.qsr.dataset import RawQuantumDataset
from netket.experimental.qsr.logic_helpers import (
    _compose_grads,
...
from netket.optimizer import PreconditionerT, identity_preconditioner
...
class QSR(AbstractVariationalDriver):
    ...
    def _forward_and_backward(self):
        ...
        self._grad_neg = jax.tree.map(lambda x: jnp.zeros_like(x), self._grad_pos)
